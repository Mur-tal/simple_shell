...
/**
 * struct token_s - function for token to indicate end of imput
...
/**
 * add_to_buf - function for buffer
...
/**
 * create_token - function to create token
...
/**
 * free_token - function to free created token after use
 * @tok: the token
 *
 * Return: 0
 */
...
/**
 * tokenize - function for tokenizer
 * @src: the source
 *
 * Return: 0
 */
